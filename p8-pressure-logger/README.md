...
🔌 Wiring Summary
1. I2C Devices (BMP180 Sensor & OLED Display) Both of these modules use the I2C bus, which means they can share the same pins!
...
The standard formula to do this looks like this: Sea Level Pressure = Current Pressure / (1 - (Altitude / 44330)) ^ 5.255

Don't worry about the heavy math, though! The Adafruit library handles this automatically for us. In our code, we use the potentiometer to dial in our local altitude (from 0 to 2000 meters). We simply pass this altitude to the sensor:
